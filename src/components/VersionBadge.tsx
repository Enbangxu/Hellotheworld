...
export function VersionBadge() {
  return (
    <div className="inline-flex items-center gap-3 rounded-full border border-cyan-300/30 bg-slate-950/35 px-4 py-2 text-left text-white shadow-lg shadow-violet-500/10 backdrop-blur-xl">
      ...
      <span><strong className="block text-sm font-black tracking-wide">V14.0</strong><span className="block text-[10px] font-bold uppercase tracking-[.13em] text-cyan-100">Latest Upgrade: AI Creation Space</span></span>
    </div>
  );
}
