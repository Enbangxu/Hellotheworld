...
export function V15Hero() {
  ...
  return <section id="home" className="v15-hero relative z-10 flex min-h-screen items-center overflow-hidden px-5 pb-20 pt-32 sm:px-8 lg:px-10">
    ...
    <motion.div initial={reduceMotion ? false : { opacity: 0, y: 26 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .75 }} className="relative mx-auto w-full max-w-5xl text-center">
      <div className="flex flex-wrap items-center justify-center gap-3"><span className="inline-flex items-center gap-2 rounded-full border border-cyan-300/30 bg-white/10 px-4 py-2 text-sm font-bold text-cyan-100 backdrop-blur-xl"><Sparkles size={16} /> V16 · AI Life Universe</span><UserLevel /></div>
      <AIGreeting />
      ...
      <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300 sm:text-2xl">欢迎来到有生命感的 AI 创意宇宙。发现灵感、连接知识，与智能伙伴一起创造未来。</p>
