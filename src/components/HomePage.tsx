...
import { DailyDiscovery } from "@/src/components/DailyDiscovery";
  ...
  return (
    <main className={`${isDark ? "dark" : ""} min-h-screen overflow-hidden`}>
      <div className="animated-gradient min-h-screen text-slate-950 transition-colors dark:text-white">
        ...
        <footer className="relative z-10 border-t border-slate-900/10 px-6 py-8 text-center text-sm font-semibold text-slate-500 dark:border-white/10 dark:text-slate-400">Hello the world · V18.0 AI Knowledge Graph</footer>
      </div>
    </main>
  );
}
