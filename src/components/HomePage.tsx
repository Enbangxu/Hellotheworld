...
export function HomePage({ locale }: { locale: Locale }) {
  ...
  const entries = [
    ...
    { title: locale === "zh" ? "AI 图片生成" : locale === "ja" ? "AI画像生成" : "AI Image Creator", description: locale === "zh" ? "用文字创造你的专属视觉作品" : locale === "ja" ? "言葉からオリジナル画像を作成" : "Turn words into original visual art", href: "/studio", icon: ImageIcon },
  ...
  return (
    <main className="minimal-home min-h-screen bg-slate-950 pb-24 text-white md:pb-0">
      ...
      <section className="relative mx-auto flex max-w-6xl flex-col items-center px-5 pb-12 pt-32 text-center sm:pt-36">
        <p className="text-xs font-bold uppercase tracking-[.28em] text-cyan-300">V24 · Unified AI Studio</p>
      ...
      <footer className="relative border-t border-white/10 px-5 py-6 text-center text-xs text-slate-500">V24 · Unified AI Studio</footer>
