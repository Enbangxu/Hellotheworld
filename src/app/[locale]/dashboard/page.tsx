...
export const metadata: Metadata = { title: "AI Personal Dashboard 2.0", description: "Your daily AI brief, agent status, creation history, memory summary, and personal recommendations." };
