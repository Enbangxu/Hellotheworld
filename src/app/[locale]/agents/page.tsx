...
export const metadata: Metadata = { title: "AI Agent Marketplace", description: "Discover, inspect, and create focused AI agents in the V11 AI Life Ecosystem.", openGraph: { title: "AI Agent Marketplace | Hello the world V11", description: "Find and share agents built for real-world creative workflows." } };
