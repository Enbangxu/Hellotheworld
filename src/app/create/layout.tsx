...
const seo = { title: "AI Creation Center", description: "Generate articles, travel plans, learning roadmaps, product introductions, SEO descriptions, and matched images with AI.", path: "/create", image: "/images/og-v8.svg" };
