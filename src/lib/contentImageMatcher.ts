...
const imageCatalog = [
  { keywords: ["travel", "trip", "weekend", "itinerary", "旅行", "旅程", "旅游", "週末", "city", "kyoto", "京都"], keyword: "travel", imageUrl: "/images/ai-travel.svg", alt: "AI-generated travel planning landscape" },
