...
export const siteContent: Record<Locale, Content> = {
  en: {
    metadata: { title: "Hello the world V15 | AI Interactive World", description: "Talk with the AI welcome assistant, discover personal recommendations, and explore a connected world of knowledge and creativity.", ogTitle: "Hello the world V15 · AI Interactive World" },
  ...
  zh: {
    metadata: { title: "Hello the world V15 | AI 智能探索与互动体验", description: "与 AI 欢迎助手对话，发现个性化推荐，探索知识、创意与世界灵感。", ogTitle: "Hello the world V15 · AI 智能互动世界" },
  ...
  ja: {
    metadata: { title: "Hello the world V15 | AI Interactive World", description: "AIウェルカムアシスタントと会話し、パーソナルなおすすめから知識と創造の世界を探索できます。", ogTitle: "Hello the world V15 · AI Interactive World" },
